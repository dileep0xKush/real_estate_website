...
export default function ThreeColumnsGallery() {

    useEffect(() => {
        // Load MixItUp only on client side
            ...
            <section id="portfolio-section" className="section-padding">
                <div className="container">
                    ...
                    <div id="portfolio" className="row wow fadeInDown">
                        ...
                        {/* Item 1 */}
                        <div className="col-md-6 col-sm-6 col-lg-4 mix development print">
                            <div className="portfolio-box">
                                ...
                                <div className="overlay-box text-center">
                                    <Link className="lightbox" href="/assets/img/gallery/img-1.jpg">
                        ...
                        {/* Item 2 */}
                        <div className="col-md-6 col-sm-6 col-lg-4 mix design print">
                            <div className="portfolio-box">
                                <div className="img-thumb">
                                    <Image src="/assets/img/gallery/img-2.jpg" alt="Gallery" width={800} height={500} className="img-fluid" />
                                </div>
                                <div className="overlay-box text-center">
                                    <Link className="lightbox" href="/assets/img/gallery/img-2.jpg">
                                        <i className="lni-zoom-in"></i>
                                    </Link>
                                    <h3>Project Title</h3>
                                </div>
                        ...
                        {/* Item 3 */}
                        <div className="col-md-6 col-sm-6 col-lg-4 mix development">
                            <div className="portfolio-box">
                                <div className="img-thumb">
                                    <Image src="/assets/img/gallery/img-3.jpg" alt="Gallery" width={800} height={500} className="img-fluid" />
                                </div>
                                <div className="overlay-box text-center">
                                    <Link className="lightbox" href="/assets/img/gallery/img-3.jpg">
                                        <i className="lni-zoom-in"></i>
                                    </Link>
                                    <h3>Project Title</h3>
                                </div>
                        ...
                        {/* Item 4 */}
                        <div className="col-md-6 col-sm-6 col-lg-4 mix development design">
                            <div className="portfolio-box">
                                <div className="img-thumb">
                                    <Image src="/assets/img/gallery/img-4.jpg" alt="Gallery" width={800} height={500} className="img-fluid" />
                                </div>
                                <div className="overlay-box text-center">
                                    <Link className="lightbox" href="/assets/img/gallery/img-4.jpg">
                                        <i className="lni-zoom-in"></i>
                                    </Link>
                                    <h3>Project Title</h3>
                                </div>
                        ...
                        <div className="col-md-6 col-sm-6 col-lg-4 mix development">
                            <div className="portfolio-box">
                                ...
                                <div className="overlay-box text-center">
                                    <Link className="lightbox" href="/assets/img/gallery/img-5.jpg">
                                        <i className="lni-zoom-in"></i>
                                    </Link>
                                    <h3>Project Title</h3>
                                </div>
                        ...
                        {/* Item 6 */}
                        <div className="col-md-6 col-sm-6 col-lg-4 mix print design">
                            <div className="portfolio-box">
                                <div className="img-thumb">
                                    <Image src="/assets/img/gallery/img-6.jpg" alt="Gallery" width={800} height={500} className="img-fluid" />
                                </div>
                                <div className="overlay-box text-center">
                                    <Link className="lightbox" href="/assets/img/gallery/img-6.jpg">
                                        <i className="lni-zoom-in"></i>
                                    </Link>
                                    <h3>Project Title</h3>
                                </div>
